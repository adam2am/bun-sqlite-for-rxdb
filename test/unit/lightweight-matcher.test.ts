...
describe('Lightweight Matcher - Comparison Operators', () => {
	const doc = { age: 25, name: 'Alice', score: 85.5 };
...
describe('Lightweight Matcher - Array Operators', () => {
	const doc = { tags: ['javascript', 'typescript'], count: 3 };
	...
	it('$elemMatch - array element matching', () => {
		const doc2 = { items: [{ price: 10 }, { price: 20 }, { price: 30 }] };
...
describe('Lightweight Matcher - Logical Operators', () => {
	const doc = { age: 25, name: 'Alice', active: true };
...
describe('Lightweight Matcher - Element Operators', () => {
	const doc = { age: 25, name: 'Alice', address: undefined };
...
describe('Lightweight Matcher - Evaluation Operators', () => {
	...
	it('$mod - modulo', () => {
		const doc = { count: 10 };
		expect(matchesSelector(doc, { count: { $mod: [3, 1] } })).toBe(true);
		expect(matchesSelector(doc, { count: { $mod: [3, 0] } })).toBe(false);
	});
});

describe('Lightweight Matcher - Nested Fields', () => {
	const doc = { user: { name: 'Alice', address: { city: 'NYC' } } };
...
describe('Lightweight Matcher - Complex Queries', () => {
	const doc = { age: 25, name: 'Alice', tags: ['javascript', 'typescript'], active: true };
